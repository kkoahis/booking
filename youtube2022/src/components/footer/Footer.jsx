      ...
      <div className="footer">
         <div className="footerLists">
            ...
            <ul className="footerList">
               ...
               <li className="footerListItem">All flight destinations</li>
            ...
            <ul className="footerList">
               ...
               <li className="footerListItem">BookingH.com for Travel Agents</li>
            </ul>
            <ul className="footerList">
               ...
               <li className="footerListItem">Press centre</li>
               <li className="footerListItem">Safety resource centre</li>
               ...
               <li className="footerListItem">MSA Statement</li>
